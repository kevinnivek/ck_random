...
s_verbs = ["licks", "sucks", "fucks", "breathes", "looks at", "meets with", "punches", "kicks", "bites", "screams", "decapitates", "sits on", "injects fluids", "gets juices on", "lubes", "moans on", "rubs", "fingers", "fists", "pinches", "tickles", "sniffs", "smells", "gawks", "coats", "slathers", "pokes", "presses", "inches", "cuts", "wipes", "cleans", "clenses", "purifies", "wet wipes", "lubricates", "mounts", "penetrates", "rimjobs", "rims", "toefucks", "slobbers", "huffs", "lubes", "grinds", "dry humps", "wet humps", "smears", "pumps", "thrusts", "pierces"]
