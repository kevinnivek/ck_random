...
s_nouns = ["A hobo", "Dondald Trump", "Bradley cooper", "Some guy", "A man with slimes", "A hobo with cheese", "A hobo with slimes", "Benjamin Moore", "Bradley", "A penis", "A sex dwarf", "A sexual man", "A sexual woman", "A sexual person", "A stinky man", "Mr Dressup", "Casey Jones", "Suzanne", "Suzy", "Susan", "Sue", "Kevin", "Kevvy", "Duncan", "Dunky", "Duncaroo", "Mike", "Hawcko", "Mike Hawcko", "Kathryn", "Lenny", "Leonardo", "Rebekah", "Danny", "Adele", "Cher", "Lela", "Dennis", "Paolo", "Anul", "A beggar", "Joe Biden", "Biden", "Neil", "Christian", "Taco", "Dan", "Ingrid", "Amy", "Aaron"]
