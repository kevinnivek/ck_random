...
s_nouns = ["Dondald Trump", "Bradley cooper", "Some guy", "A man with slimes", "A hobo with cheese", "A hobo with slimes", "Benjamin Moore", "Bradley", "A penis", "A sex dwarf", "A sexual man", "A sexual woman", "A sexual person", "A stinky man", "Mr Dressup", "Casey Jones", "Suzanne", "Suzy", "Susan", "Sue", "Kevin", "Kevvy", "Duncan", "Dunky", "Duncaroo", "Mike", "Hawcko", "Mike Hawcko", "Kathryn", "Lenny", "Leonardo", "Rebekah", "A beggar", "Joe Biden", "Biden", "Neil", "Christian", "Taco", "Dan", "Ingrid", "Amy", "Aaron", "Matt Galloway", "John", "Beverley", "Jean-Luc", "Picard", "Riker", "Ricky", "Judy Blume", "Bradley", "A man with smegma", "A man", "A woman", "Elliott", "Ellen", "Pussywillow", "Barkley", "Quark", "Nog", "Bashere", "Dukat", "Julie Dzerowicz", "Kruti", "Dean Koontz", "Leon", "Beverley", "Dale", "Billy", "Jen", "Vic", "Alex", "Pat", "Don", "Margie", "case-k", "Case-k", "Ian", "James", "Keith", "Doreen", "Pat King", "Tamara Lich", "Maggy", "Matt Brown", "Jubal", "Nathan", "Duncan", "Julie", "Matt", "Dan Ross", "Sean Marvin", "Sean", "Rob", "Maria", "Mariar", "Janet", "Henry", "Ken", "Kenneth", "Donald", "Kamala", "Cathy", "Mattias", "Sean Springer"]
